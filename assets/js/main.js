...
function showSize() {
  ...
  befTxt.innerHTML = "Uploaded file size: "+(befSize)+" KB";
  ...
  reader.onload = function() {
    ...
    img.onload = function() {
      ...
      canvas.toBlob(function(blob) {
        ...
        var nama = "IMGCOM - "+file.name;
        downloadBtn.download = nama;
        const output = document.getElementById("output");
        const befTxt = document.getElementById("befTxt");
        befTxt.innerHTML = "File size before compression: "+befSize+" KB";
        const sizeTxt = document.getElementById("sizeTxt");
        sizeTxt.innerHTML = "File size after compression: "+aftSize+" KB";
        output.src = url;
